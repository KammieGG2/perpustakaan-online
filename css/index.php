...
<head>
    <meta charset="UTF-8">
    <title>PerPus SMK BPP Bandung || Membaca menjadi lebih mudah!</title>
    ...
    <meta name="PerPus SMK BPP" content="PerPus SMK BPP" />
    <!-- bootstrap 3.0.2 -->
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="alert alert-info alert-dismissable">
                            ...
                            <b>Selamat Datang di PerPus SMK BPP Bandung, Untuk Login silahkan klik Icon User atau klik <a href="login.html">disini</a></b> 
                                ...
                                <div class="twt-area">
                                    <form class="form-horizontal style-form" style="margin-top: 20px;" action="insert-pengunjung.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea rows="4" name="saran" id="saran" class="form-control" placeholder="Saran Anda untuk Perpus SMK BPP" cols="25"></textarea>
                                                <!--<span class="help-block">A block of help text that breaks onto a new line and may extend beyond one line.</span>-->
                                            </div>
                                        </div>
                                        <div class="form-group">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">PerPus SMK BPP</h4>
                </div>
                <div class="modal-body">
                    <p> PerPus SMK BPP adalah salah satu layanan bagi pengguna untuk dapat mengakses berbagai buku bacaan yang dan dilakukan kapan saja dan dari mana saja, dengan menggunakan jaringan internet.</p>
                    <p> PerPus SMK BPP memiliki koleksi buku dalam bentuk format digital dan bisa diakses dengan komputer. koleksi bacaan dari PerpustakaanKu dapat diakses dengan cepat dan mudah lewat jaringan komputer.</p>
                    <p> PerPus SMK BPP bebasis website yang responsif, untuk info, saran, maupun kritik bisa menghubungi kami :</p>
                    <table>
                        <tr>
                            <td>E-mail</td>
                            <td>:</td>
                            <td><a href="sisteminformasi494@gmail.com">PerPusSMKBPP@gmail.com</a></td>
                        </tr>
                        <br />
                        <tr>
                            <td>Blog</td>
